...
@XStreamAlias("root")
public class TaHfnbToaXml2011 extends TaHfnbToaXml {
    public TaHfnbToaXmlInfo info = new TaHfnbToaXmlInfo();
    public Body Body = new Body();

    public TaHfnbToaXml2011.Body getBody() {
        return Body;
    }

    public void setBody(TaHfnbToaXml2011.Body body) {
        Body = body;
    }
    ...
    public String toString() {
        ...
        xs.processAnnotations(TaHfnbToaXml2011.class);
        return "<?xml version=\"1.0\" encoding=\"GBK\"?>" + "\n" + xs.toXML(this);
    }

    public static TaHfnbToaXml2011 getToa(String xml) {
        XStream xs = new XStream(new DomDriver());
        xs.processAnnotations(TaHfnbToaXml2011.class);
        return (TaHfnbToaXml2011) xs.fromXML(xml);
    }
}
