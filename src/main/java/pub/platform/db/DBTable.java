    ...
    public String writeExcel_new(WritableWorkbook book, String SqlStr, String whereStr, String fieldCN, String fieldType,String fieldWidth,String visible, String enumType) {
        ...
        try {
            ...
            */
            ...
            // 边框样式
            wcf_money.setBorder(Border.ALL, BorderLineStyle.THIN);
            // 折行
...
//            WritableCellFormat wcf_number = new WritableCellFormat(nf);
            ...
            // 边框样式
            wcf_number.setBorder(Border.ALL, BorderLineStyle.THIN);
            // 折行
            ...
            // 边框样式
            wcf_text_left.setBorder(Border.ALL, BorderLineStyle.THIN);
            // 折行
            ...
            // 边框样式
            wcf_text_center.setBorder(Border.ALL, BorderLineStyle.THIN);
            // 折行
